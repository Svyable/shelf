...
Later chapters widen the same question from one treatment to a system: whose HLA alleles are represented well enough for prediction, who gets usable sequencing, how clinical trials become part of the individualized factory, whether public capacity should preserve long-tail access, how combination therapy changes the bill, and how evidence should travel when a patient, clinic and manufacturer cross jurisdictions.
