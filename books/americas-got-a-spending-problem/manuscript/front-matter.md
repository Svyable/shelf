...
Instead of asking whether something is worth what it costs, we ask whether we can handle the payment. Instead of asking whether a public promise is funded, we ask whether somebody can find the votes to continue it. Instead of asking why a hospital procedure costs what it does, we ask which line on the insurance statement applies. Instead of asking why housing is scarce, we argue about who deserves help bidding on the scarce houses. Instead of asking whether a college program creates enough value to justify its full cost, we compare aid packages that make the sticker price nearly fictional.
...
There are fewer good reasons to send tomorrow a bill we were unwilling to read ourselves.
