...
This work may be publicly readable through an official publication or working-proof surface chosen by the copyright owner. Public availability, source-visible Markdown, Git history, or a public Reader does not place the work in the public domain and does not grant an open-source or Creative Commons license.
